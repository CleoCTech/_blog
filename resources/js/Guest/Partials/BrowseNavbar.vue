...
onMounted(() => {
    axios.get('/footer-data').then(response => {
        form.footerData = response.data;
    ...
    <div v-if="!isLoading.value">
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
            ...
            <div class="mt-10 sm:mt-20">
                <Link v-for="subcategory in subcategories" :key="subcategory.uuid" 
                    ...
                    :href="'/browse/'+category.title.replace(/ /g,'-').toLowerCase()+'/' +subcategory.title.replace(/ /g,'-').toLowerCase()">
                   <div v-html="subcategory.svg"></div>
                    {{subcategory.title}}
                </Link>
