    ...
    <div id="docs-sidebar" 
     ...
     <nav id="sidebar-nav" class="relative space-y-8">
       ...
       <ul class="ml-0.5 space-y-2 border-l-2 border-slate-100 dark:border-slate-800" data-hs-scrollspy="#scrollspy">
           <sidebar-link :href="route('guest-dashboard')" :active="$page.url == '/dashboard'" class="cursor-pointer uppercase"><Icon icon="mdi:home" class="inline-block text-3xl -pt-3 -top-1"/> Home</sidebar-link>
       ...
       <Icon icon="mdi:list-box-outline" class="inline-block text-2xl mr-1 "/>
           ...
           <sidebar-link :href="route('guest-post')" :active="$page.url == '/guest/post'" class="cursor-pointer  "><Icon icon="mdi:chevron-right" class="inline-block mr-1 "/>Posts</sidebar-link>
